...
public class EmbedMessageBuilder {
  ...
  public void getHelpEmbed(int pageNumber) {
    ...
    switch (pageNumber) {
      ...
      case 2 -> {
        embed.setTitle("Help");
        embed.setDescription("This is a list of command that can be used when the quiz is prepared.");
  ...
  public void setEmbedSetting(QuizSettings settings){
    ...
    embed.setTitle(settings.getTitle())
        .setDescription("This is the parameters of the quiz")
        .addField("Room Master","",true)
        .addField(settings.getRoomMaster().getName(),"",true)
        .addBlankField(false)
        .addField("Number of questions","",true)
        .addField(String.valueOf(settings.getQuestionNumber()),"",true)
        .addBlankField(false)
        .addField("Number of choices","",true)
        .addField(String.valueOf(settings.getChoicesNumber()),"",true)
        .addBlankField(false)
        .addField("Time to choose an answer","",true)
        .addField(String.valueOf(settings.getTimeToAnswer()),"",true)
        .addBlankField(false)
        .addField("Time to before the answers are shown","",true)
        .addField(String.valueOf(settings.getTimeToShowChoices()),"",true)
        .addBlankField(false)
        .addField("Time to pass to the next question","",true)
        .addField(String.valueOf(settings.getTimeToPassToNext()),"",true)
        .addBlankField(false)
        .addField("Players","",true)
        .addField(builder.toString(),"",true);
  }
}
